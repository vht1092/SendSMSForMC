...
{
    public class classExpiredExtensionLogWriter
    {
        public static FileStream fs;
        public static StreamWriter w;
        public static TextWriter tw;

        public classExpiredExtensionLogWriter()
        {
            fs = null;
            w = null;
        }
        ...
        public static void OpenFileWriter()
        {
            ...
            string filename = rootpath + "\\log\\" + "ExpiredExtension_" + DateTime.Today.ToString("yyyyMMdd") + ".log";
            try
            {
