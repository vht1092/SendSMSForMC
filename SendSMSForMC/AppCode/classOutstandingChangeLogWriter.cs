...
{
    class classOutstandingChangeLogWriter
    {
        public static FileStream fs;
        public static StreamWriter w;

        public classOutstandingChangeLogWriter()
        {
            fs = null;
            w = null;
        }
        ...
        public static void OpenFileWriter()
        {
            ...
            string filename = rootpath + "\\log\\" + "OutstandingChange_" + DateTime.Today.ToString("yyyyMMdd") + ".log";
            try
            {
