...
{
    class classReminderPayment1LogWriter
    {
        public static FileStream fs;
        public static StreamWriter w;

        public classReminderPayment1LogWriter()
        {
            fs = null;
            w = null;
        }
        ...
        public static void OpenFileWriter()
        {
            ...
            string filename = rootpath + "\\log\\" + "ReminderPayment1_" + DateTime.Today.ToString("yyyyMMdd") + ".log";
            try
            {
