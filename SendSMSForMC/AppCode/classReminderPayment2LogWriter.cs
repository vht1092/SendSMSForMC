...
{
    class classReminderPayment2LogWriter
    {
        public static FileStream fs;
        public static StreamWriter w;

        public classReminderPayment2LogWriter()
        {
            fs = null;
            w = null;
        }
        ...
        public static void OpenFileWriter()
        {
            ...
            string filename = rootpath + "\\log\\" + "ReminderPayment2_" + DateTime.Today.ToString("yyyyMMdd") + ".log";
            try
            {
